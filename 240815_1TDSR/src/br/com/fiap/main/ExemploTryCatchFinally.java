...
public class ExemploTryCatchFinally {
    public static void main(String[] args) {
        try {
            String aux1 = JOptionPane.showInputDialog("Forneça o valor do 1ª número." +
                    "Faixa permitida de 1 à 50.");
            int num1 = Integer.parseInt(aux1);
            if (num1 < 1 || num1 > 50) {
                throw new Exception("Número informado fora da faixa permitida.");
            }
            String aux2 = JOptionPane.showInputDialog("Forneça o valor do 2ª número.");
