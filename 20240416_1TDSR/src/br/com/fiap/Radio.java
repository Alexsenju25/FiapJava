...
public class Radio {
	...
	public Radio() { // construtor vazio
	}
	public Radio(int volume, float estacao) { // construtor com passagem de parâmetros
		setVolume(volume);
		setEstacao(estacao);
	}
	...
	public void setEstacao(float estacao) {
		try {
			if (estacao >= 80.0f && estacao <= 105.0f) {
				...
				this.estacao = 80.0f;
				throw new Exception("Estação fora de sintonia (80.0-105.0MHz)");
			}
